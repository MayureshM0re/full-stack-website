...
const res = loadFacts(
  "'https://fooxzlurlmfdabuabkai.supabase.co/rest/v1/facts",
  {
    headers: {
      apikey:
        "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImZvb3h6bHVybG1mZGFidWFia2FpIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MDQ5OTkzNTIsImV4cCI6MjAyMDU3NTM1Mn0.WtU5ugZQplvh2IjbvvGi3EdYheL1lsOHPhDp0FUtGEw",
      authorization:
        "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImZvb3h6bHVybG1mZGFidWFia2FpIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MDQ5OTkzNTIsImV4cCI6MjAyMDU3NTM1Mn0.WtU5ugZQplvh2IjbvvGi3EdYheL1lsOHPhDp0FUtGEw",
    },
  }
);
console.log(res);
